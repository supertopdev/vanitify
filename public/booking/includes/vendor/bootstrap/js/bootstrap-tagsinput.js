...
(function($) {
  ...
  var defaultOptions = {
    tagClass: function(item) {
      return "label label-info btn btn-dark btn-sm";
    },
  ...
  function TagsInput(element, options) {
    ...
    this.$container = $('<div class="saaappoint-bootstrap-tagsinput col-md-12"></div>');
    this.$input = $(
      '<input type="text" class="saasappoint-tags-input w-100" placeholder="' + this.placeholderText + '"/>'
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      if (
        ...
        self.$container.addClass("saaappoint-bootstrap-tagsinput-max");
    ...
    remove: function(item, dontPushVal, options) {
      ...
      if (self.options.maxTags > self.itemsArray.length)
        self.$container.removeClass("saaappoint-bootstrap-tagsinput-max");
