...
?>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="<?php echo SITE_URL; ?>backend/c-support-tickets.php">Support Tickets</a>
        </li>
      ...
      <div class="card mb-3">
        <div class="card-header">
		  ...
		  <a class="btn btn-primary btn-sm saasappoint-white pull-right" href="<?php echo SITE_URL; ?>backend/c-support-tickets.php"><i class="fa fa-angle-double-left"></i> Back to Support Tickets</a>
		</div>
        <div class="card-body">
