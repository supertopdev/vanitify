				...
				<div class="row">
					<div class="col-md-8 saasappoint-login-left-block">
						...
						<div class="saasappoint-banner-text-top-left">
							...
							<a href="<?php echo SITE_URL; ?>" class="saasappoint-continue-booking-link mt-3 text-white">Continue Booking >></a>
						</div>
					</div>
					<div class="col-md-4 saasappoint-login-right-block">
						...
						<form id="saasappoint_login_form" name="saasappoint_login_form">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="saasappoint_login_email" name="saasappoint_login_email" placeholder="Enter email" value="<?php echo isset($_COOKIE['saasappoint_email'])?$_COOKIE['saasappoint_email'] : ""; ?>" />
							</div>
							<div class="form-group">
								<label for="saasappoint_login_password">Password</label>
								<input type="password" class="form-control" id="saasappoint_login_password" name="saasappoint_login_password" placeholder="Enter password" value="<?php echo isset($_COOKIE['saasappoint_password'])?$_COOKIE['saasappoint_password'] : ""; ?>" />
						...
						<p class="text-left mt-4"><a href="<?php echo SITE_URL; ?>backend/forgot-password.php">Lost your password?</a></p>
						<hr />
						<p class="text-center mt-4">Need an account? <a href="<?php echo SITE_URL; ?>backend/signup-as.php">Sign Up</a></p>
