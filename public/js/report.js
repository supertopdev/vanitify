$(document).ready( function(){
    ...
    if($('#sr_date_filter').length == 1){
        ...
        sr_sales_report = $('table#sr_sales_report').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                $('#sr_footer_payment_status_count ').html(__sum_status_html($('#sr_sales_report'), 'payment-status-label'));
        ...
        sr_expenses_report = $('table#sr_expenses_report').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                $('#er_footer_payment_status_count').html(__sum_status_html($('#sr_expenses_report'), 'payment-status'));
        ...
        sr_sales_commission_report = $('table#sr_sales_with_commission_table').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                $('#footer_payment_status_count ').html(__sum_status_html($('#sr_sales_with_commission_table'), 'payment-status-label'));
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $('#footer_total_adjusted').html(__sum_stock($('#product_purchase_report_table'), 'quantity_adjusted'));
