          ...
          <table class="table bg-gray">
            ...
            @foreach($sell->sell_lines as $sell_line)
              <tr>
                ...
                @endif
                <td><span class="display_currency" data-currency_symbol="false">{{ $sell_line->quantity }}</span> @if(!empty($sell_line->sub_unit)) {{$sell_line->sub_unit->short_name}} @else {{$sell_line->product->unit->short_name}} @endif</td>
                <td>
