...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        $not_linked_payments = TransactionPayment::leftjoin('transactions as T', 
    ...
    public function show($id)
    {
        ...
        $business_id = request()->session()->get('user.business_id');
         ...
         if (request()->ajax()) {
            $accounts = AccountTransaction::join('accounts as A', 
                            'account_transactions.account_id', '=', 'A.id')
    ...
    public function getAccountBalance($id){
        ...
        $business_id = session()->get('user.business_id');
        $account = Account::leftjoin('account_transactions as AT', 'AT.account_id', '=', 
                            'accounts.id')
