...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($all_locations as $loc_id => $loc_name) {
            ...
            foreach ($dates as $date) {
                $sell = $sells_by_location->first(function ($item) 
                    use($loc_id, $date){
        ...
        foreach ($all_locations as $loc_id => $loc_name) {
            ...
            foreach ($fy_months as $month) {
                $sell = $fy_sells_by_location->first(function ($item) 
                    use($loc_id, $month){
    ...
    public function loadMoreNotifications()
    {
        ...
        return view('layouts.partials.notification_list', compact('notifications', 'from_ajax'));
    }
}
