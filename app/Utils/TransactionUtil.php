...
class TransactionUtil extends Util
{
    ...
    public function createSellTransaction($business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
        ...
        $transaction = Transaction::create([
            ...
            'transaction_source' => !empty($input['transaction_source']) ? $input['transaction_source'] : null,
        ]);
    ...
    protected function _receiptDetailsSellLines($lines, $il, $business_details)
    {
        ...
        foreach ($lines as $line) {
            ...
            $line_array = [
                ...
                'quantity' => $this->num_f($line->quantity, false, $business_details),
                'units' => $unit_name,
    ...
    protected function _receiptDetailsSellReturnLines($lines, $il, $business_details)
    {
        ...
        foreach ($lines as $line) {
            ...
            $line_array = [
                ...
                'variation' => (empty($variation->name) || $variation->name == 'DUMMY') ? '' : $variation->name,
                //Field for 2nd column
                'quantity' => $this->num_f($line->quantity_returned, false, $business_details),
                'units' => $unit_name,
    ...
    */
    ...
    {
        $paid = TransactionPayment::where('transaction_id', 
                        $transaction_id)->sum('amount');
        return $paid;
    }
     ...
     * @return array
     */
    public function getTransactionTotals($business_id, 
            $transaction_types,
            $start_date = null,
            $end_date = null,
            $location_id = null,
